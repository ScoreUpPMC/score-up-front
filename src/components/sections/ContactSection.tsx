        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-xl bg-white p-8 shadow">
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <button type="submit" className="rounded-lg bg-[#00a99d] px-6 py-3 font-semibold text-white">Enviar</button>
            </form>
          </div>
          <div className="rounded-xl bg-neutral-50 p-8">
            <div className="space-y-4">
              <a href="mailto:hola@scoreup.com" className="flex items-center gap-3 transition-colors hover:text-[#00a99d]">
                <span className="inline-block h-5 w-5 rounded-full bg-[#00a99d]" /> hola@scoreup.com
              </a>
              <a href="tel:+34900123456" className="flex items-center gap-3 transition-colors hover:text-[#00a99d]">
                <span className="inline-block h-5 w-5 rounded-full bg-[#00a99d]" /> +34 900 123 456
              </a>
              <a href="/#pricing" className="flex items-center gap-3 transition-colors hover:text-[#00a99d]">
                <span className="inline-block h-5 w-5 rounded-full bg-[#00a99d]" /> Ver precios
              </a>
              <a href="/#how-it-works" className="flex items-center gap-3 transition-colors hover:text-[#00a99d]">
                <span className="inline-block h-5 w-5 rounded-full bg-[#00a99d]" /> Ver cómo funciona
              </a>
            </div>
          </div>
        </div>
